      ...
      <div className="columns">
        ...
        <div className="column is-6 has-text-centered">
          <div className="abouttext has-text-centered">
            ...
            <p>I remember in the offtimes of high school I was arranging songs from all their different albums- by their mood, pace and intensity- into different playlists. I would spend hours and have a lot of fun just doing that.</p>
